...
const Produto = ({item}) => {
 ...
 {modalItem && <div className="fixed inset-0 flex bg-black bg-opacity-10 backdrop-blur-sm justify-center z-30">
      <div className='w-full bg-white h-screen overflow-y-scroll max-w-md relative rounded-md flex flex-col'>
        ...
        <div className='relative right-2 flex items-center justify-end mb-2 bottom-2'>
